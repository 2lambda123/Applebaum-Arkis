...
#TODO
#As of now nodes in general and in a hyperedge are unordered
#Stabilise that. Needs to be accounted for especially for f
...
def execute():
    ...
    for item in nodes:
        if item in ['1', '4', '7', '10', '13']:
            print('The shares of node', item, 'are:')
            shamir1 = shares[item][0]
            cds = shares[item][1]
            shamir2 = shares[item][2]
            print(shamir1, cds, shamir2)
            #print(shamir1)
            #for v in cds:
            #    print(v)
            #print(shamir2)
